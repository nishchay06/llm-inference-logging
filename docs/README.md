...
| Doc | What it covers |
|---|---|
| [sdk-design.md](./sdk-design.md) | The instrumentation layer: decoupled concerns (schema / capture / application / normalization / sink), the provider adapters, and why capture observes but never suppresses |
...
| [auto-instrumentation.md](./auto-instrumentation.md) | **How the app captures telemetry by default** — patching both call shapes on both provider SDKs, the shared capture core, and the honest limits |
